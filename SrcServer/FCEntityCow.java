...
public class FCEntityCow extends EntityCow
{
    ...
    public FCEntityCow( World world )
    {
        ...
        tasks.addTask( 6, new FCEntityAIMoveToLooseFood( this, 0.2F ) );
        tasks.addTask( 7, new FCEntityAIMoveToGraze( this, 0.2F ) );        
	...
	protected void GiveBirthAtTargetLocation( EntityAnimal targetMate, double dChildX, double dChildY, double dChildZ )
    {
    	...
    	{
    		if ( worldObj.provider.dimensionId != 1 && worldObj.getWorldInfo().getGameType() != EnumGameType.CREATIVE && worldObj.rand.nextInt( 2 ) == 0 )
    		{
    ...
    {
        return new FCEntityCow( worldObj );
    }
    ...
    public void ConvertToMooshroom()
    {
        ...
        FCEntityCow entityMooshroom = new EntityMooshroom( worldObj );
    	...
    	double dChildX, double dChildY, double dChildZ )
    {
    	...
    	if ( iRandomFactor == 0 )
    	{
            FCEntityCaveSpider childEntity = new FCEntityCaveSpider( worldObj );
    	...
    	else if ( iRandomFactor < 4 )
    	{
    		...
    		{
	            FCEntityBat childEntity = new FCEntityBat( worldObj );
    	...
    	else if ( iRandomFactor < 7 )
    	{
    		...
    		{
	            EntitySilverfish childEntity = new EntitySilverfish( worldObj );
    	...
    	{
            FCEntitySquid childEntity = new FCEntitySquid( worldObj );
